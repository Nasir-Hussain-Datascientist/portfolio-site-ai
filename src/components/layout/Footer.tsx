...
export default function Footer() {
  ...
  const socialLinks = [
    { name: 'LinkedIn', icon: Linkedin, url: 'https://www.linkedin.com/in/nasirhussain-datascience/?skipRedirect=true', color: 'hover:text-blue-400' },
    { name: 'GitHub', icon: Github, url: 'https://github.com/nasir-hussain-datascientist', color: 'hover:text-gray-400' },
    { name: 'Facebook', icon: Facebook, url: 'https://web.facebook.com/nasir.hussain.819767', color: 'hover:text-blue-600' },
    { name: 'Instagram', icon: Instagram, url: 'https://www.instagram.com/im.nasirhussain/', color: 'hover:text-pink-500' },
    { 
      name: 'TikTok', 
